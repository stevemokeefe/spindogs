...
function unstickCurrentColumn() {
    ...
    rows.forEach((row)=>{
        ...
        cells.sort((a, b)=>parseInt(getColIndex(a)) - parseInt(getColIndex(b))).forEach((cell)=>row.appendChild(cell));
    });
...
function stickColumn(colIndex) {
    ...
    // Sync checkboxes
    checkboxes.forEach((cb)=>cb.checked = cb.getAttribute("data-col") === colIndex);
}
function toggleColumn(colIndex) {
    if (colIndex === currentStickyIndex) unstickCurrentColumn();
    else stickColumn(colIndex);
}
// Event Handlers
...
},{}]},["93v64","lhpGb"], "lhpGb", "parcelRequirec9d8", {})

//# sourceMappingURL=spindogs.b828852a.js.map
